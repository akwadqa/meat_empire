...
/// Create a copy of Discounts
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? a = null,Object? p = null,}) {
...
class _Discounts implements Discounts {
   _Discounts({@JsonKey(name: 'A') required this.a, @JsonKey(name: 'P') required this.p});
...
/// Create a copy of Discounts
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? a = null,Object? p = null,}) {
