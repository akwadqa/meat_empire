...
class CartResponse {
    ...
    CartResponse({this.allowMultipleProfiles, this.userProfiles, this.cart, this.totalProducts, this.message, this.success});

    CartResponse.fromJson(Map<String, dynamic> json) {
        allowMultipleProfiles = json["allow_multiple_profiles"];
        userProfiles = json["user_profiles"] == null ? null : (json["user_profiles"] as List).map((e) => UserProfiles.fromJson(e)).toList();
    ...
    CartResponse copyWith({
        ...
        allowMultipleProfiles: allowMultipleProfiles ?? this.allowMultipleProfiles,
...
class Cart {
    ...
    Cart({this.products, this.shippingCost, this.displayShippingCost, this.taxSubtotal, this.discount, this.total, this.amount, this.originalSubtotal, this.displaySubtotal, this.subtotal, this.useDiscount, this.companyShippingFailed, this.shippingFailed, this.storedTaxes, this.coupons, this.recalculate, this.calculateShipping, this.freeShipping, this.optionsStyle, this.shippingRequired, this.noPromotions, this.subtotalDiscount, this.hasCoupons, this.productGroups, 
     this.chosenShipping, this.chosenShippingDisabled, this.pointsInfo, this.taxSummary, this.taxes, this.discountedSubtotal, this.userData, this.profileId, this.guestCheckout, this.locationHash, this.paymentSurcharge, this.formatSubtotal, this.formatDisplaySubtotal, this.formatTotal, this.formatShippingCost, this.formatDiscountedSubtotal, this.formatPaymentSurcharge, this.formatSubtotalDiscount, this.formatTaxSubtotal, this.cartProducts, this.shippings, this.paymentId, this.orderId, this.couponsDetails, this.deliverySlots});
    ...
    Cart.fromJson(Map<String, dynamic> json) {
        ...
        productGroups = json["product_groups"] == null ? null : (json["product_groups"] as List).map((e) => ProductGroups.fromJson(e)).toList();
        chosenShipping = json["chosen_shipping"] == null ? null : List<int>.from(json["chosen_shipping"]);
        chosenShippingDisabled = json["chosen_shipping_disabled"];
        pointsInfo = json["points_info"] == null ? null : PointsInfo.fromJson(json["points_info"]);
        taxSummary = json["tax_summary"] == null ? null : TaxSummary.fromJson(json["tax_summary"]);
        taxes = json["taxes"] == null ? null : (json["taxes"] as List).map((e) => Taxes.fromJson(e)).toList();
        discountedSubtotal = json["discounted_subtotal"];
        userData = json["user_data"] == null ? null : UserData2.fromJson(json["user_data"]);
        ...
        shippings = json["shippings"] == null ? null : (json["shippings"] as List).map((e) => Shippings1.fromJson(e)).toList();
        paymentId = json["payment_id"];
        orderId = json["order_id"];
        couponsDetails = json["coupons_details"] ?? [];
        deliverySlots = json["delivery_slots"] == null ? null : (json["delivery_slots"] as List).map((e) => DeliverySlots.fromJson(e)).toList();
    }
    ...
    Cart copyWith({
        ...
        companyShippingFailed: companyShippingFailed ?? this.companyShippingFailed,
        ...
        chosenShippingDisabled: chosenShippingDisabled ?? this.chosenShippingDisabled,
        ...
        formatDisplaySubtotal: formatDisplaySubtotal ?? this.formatDisplaySubtotal,
        formatTotal: formatTotal ?? this.formatTotal,
        formatShippingCost: formatShippingCost ?? this.formatShippingCost,
        formatDiscountedSubtotal: formatDiscountedSubtotal ?? this.formatDiscountedSubtotal,
        formatPaymentSurcharge: formatPaymentSurcharge ?? this.formatPaymentSurcharge,
        formatSubtotalDiscount: formatSubtotalDiscount ?? this.formatSubtotalDiscount,
...
class DeliverySlots {
    ...
    DeliverySlots({this.date, this.timestamp, this.heading, this.subheading, this.unavailable, this.reason, this.slots});
...
class Shippings1 {
    ...
    Shippings1({this.shippingId, this.shipping, this.description, this.serviceDeliveryTime, this.rate, this.formatRate});
...
class CartProducts {
    ...
    CartProducts({this.productId, this.companyId, this.categoryIds, this.productCode, this.weight, this.tracking, this.product, this.shortDescription, this.isEdp, this.edpShipping, this.shippingFreight, this.freeShipping, this.zeroPriceAction, this.taxIds, this.qtyStep, this.listQtyCount, this.maxQty, this.minQty, this.inStock, this.shippingParams, this.companyStatus, this.outOfStockActions, this.updatedTimestamp, this.companyName, this.trackingRaw, this.zeroPriceActionRaw, this.minQtyRaw, this.maxQtyRaw, this.qtyStepRaw, this.listQtyCountRaw, this.mainCategory, this.optionsCount, this.price, this.basePrice, this.isPbp, this.isOper, this.isOp, this.calculation, this.originalPrice, this.modifiersPrice, this.amount, this.storedPrice, this.productOptions, this.storedDiscount, this.subtotal, this.displayPrice, this.displaySubtotal, this.mainPair, this.hasOptions, this.discounts, this.qtyContent, this.detailedParams, this.itemId, this.formatPrice, this.formatSubtotal, this.formatDisplaySubtotal, this.formatBasePrice, this.formatOriginalPrice, this.imageUrl, this.wishlistId});
    ...
    CartProducts.fromJson(Map<String, dynamic> json) {
        ...
        shippingParams = json["shipping_params"] == null ? null : ShippingParams.fromJson(json["shipping_params"]);
        ...
        displaySubtotal = json["display_subtotal"];
        mainPair = json["main_pair"] == null ? null : MainPair2.fromJson(json["main_pair"]);
        hasOptions = json["has_options"];
        discounts = json["discounts"] == null ? null : Discounts.fromJson(json["discounts"]);
        qtyContent = json["qty_content"] ?? [];
        detailedParams = json["detailed_params"] == null ? null : DetailedParams.fromJson(json["detailed_params"]);
        itemId = json["item_id"];
...
class DetailedParams {
    ...
    DetailedParams({this.getIcon, this.getDetailed, this.getAdditional, this.getOptions, this.getDiscounts, this.getFeatures, this.getExtra, this.getTaxedPrices, this.getForOneProduct, this.detailedParams, this.featuresDisplayOn, this.getActiveOptions, this.getOnlySelectableOptions, this.getVariationInfo, this.getVariationFeaturesVariants, this.getVariationName, this.getProductType});
    ...
    DetailedParams copyWith({
        ...
        getOnlySelectableOptions: getOnlySelectableOptions ?? this.getOnlySelectableOptions,
        getVariationInfo: getVariationInfo ?? this.getVariationInfo,
        getVariationFeaturesVariants: getVariationFeaturesVariants ?? this.getVariationFeaturesVariants,
...
class MainPair2 {
    ...
    MainPair2({this.pairId, this.imageId, this.detailedId, this.position, this.objectId, this.objectType, this.detailed});
    ...
    MainPair2.fromJson(Map<String, dynamic> json) {
        ...
        detailed = json["detailed"] == null ? null : Detailed2.fromJson(json["detailed"]);
    }
...
class Detailed2 {
    ...
    Detailed2({this.objectId, this.objectType, this.type, this.imagePath, this.alt, this.imageX, this.imageY, this.httpImagePath, this.httpsImagePath, this.absolutePath, this.relativePath, this.isHighRes});
...
class ShippingParams {
    ...
    ShippingParams({this.minItemsInBox, this.maxItemsInBox, this.boxLength, this.boxWidth, this.boxHeight});
...
class UserData2 {
    ...
    UserData2 copyWith({
        ...
        purchaseTimestampFrom: purchaseTimestampFrom ?? this.purchaseTimestampFrom,
        purchaseTimestampTo: purchaseTimestampTo ?? this.purchaseTimestampTo,
        responsibleEmail: responsibleEmail ?? this.responsibleEmail,
        passwordChangeTimestamp: passwordChangeTimestamp ?? this.passwordChangeTimestamp,
        ...
        profileUpdateTimestamp: profileUpdateTimestamp ?? this.profileUpdateTimestamp,
...
class ProductGroups {
    ...
    ProductGroups({this.groupId, this.companyId, this.companyName, this.shippings, this.selectedShippingId, this.shippingCost, this.products});

    ProductGroups.fromJson(Map<String, dynamic> json) {
        groupId = json["group_id"];
        companyId = json["company_id"];
        companyName = json["company_name"];
        shippings = json["shippings"] == null ? null : (json["shippings"] as List).map((e) => Shippings.fromJson(e)).toList();
        selectedShippingId = json["selected_shipping_id"];
        shippingCost = json["shipping_cost"];
        products = json["products"] == null ? null : (json["products"] as List).map((e) => Products1.fromJson(e)).toList();
    }
...
class Products1 {
    ...
    Products1({this.userId, this.timestamp, this.type, this.userType, this.itemId, this.itemType, this.productId, this.amount, this.price, this.sessionId, this.ipAddress, this.orderId, this.storefrontId, this.position, this.companyId, this.productCode, this.product, this.productOptions, this.storedPrice, this.mainPair, this.extra, this.storedDiscount, this.amountTotal, this.optionsType, this.exceptionsType, this.optionsTypeRaw, this.exceptionsTypeRaw, this.modifiersPrice, this.isEdp, this.edpShipping, this.discount, this.promotions, this.basePrice, this.categoryIds, this.displayPrice, this.firstname, this.lastname, this.phone, this.email, this.userData, this.groupId, this.chosenShipping, this.mainCategory, this.subtotal, this.formatPrice, this.formatSubtotal, this.formatBasePrice, this.imageUrl, this.companyName, this.wishlistId});
    ...
    Products1.fromJson(Map<String, dynamic> json) {
        ...
        productCode = json["product_code"];
        product = json["product"];
        productOptions = json["product_options"] == null ? null : (json["product_options"] as List).map((e) => ProductOptions2.fromJson(e)).toList();
        storedPrice = json["stored_price"];
        mainPair = json["main_pair"] == null ? null : MainPair1.fromJson(json["main_pair"]);
        ...
        phone = json["phone"];
        email = json["email"];
        userData = json["user_data"] == null ? null : UserData1.fromJson(json["user_data"]);
        groupId = json["group_id"];
...
class UserData1 {
    ...
    UserData1({this.userId, this.status, this.userType, this.userLogin, this.referer, this.isRoot, this.companyId, this.lastActivity, this.timestamp, this.salt, this.firstname, this.lastname, this.company, this.email, this.phone, this.fax, this.url, this.taxExempt, this.langCode, this.birthday, this.purchaseTimestampFrom, this.purchaseTimestampTo, this.responsibleEmail, this.passwordChangeTimestamp, this.apiKey, this.helpdeskUserId, this.janrainIdentifier, this.profileId, this.profileType, this.bFirstname, this.bLastname, this.bAddress, this.bAddress2, this.bCity, this.bCounty, this.bState, this.bCountry, this.bZipcode, this.bPhone, this.sFirstname, this.sLastname, this.sAddress, this.sAddress2, this.sCity, this.sCounty, this.sState, this.sCountry, this.sZipcode, this.sPhone, this.sAddressType, this.profileName, this.profileUpdateTimestamp, this.fields, this.bCountryDescr, this.sCountryDescr, this.bStateDescr, this.sStateDescr, this.points});
...
class MainPair1 {
    ...
    MainPair1({this.pairId, this.imageId, this.detailedId, this.position, this.objectId, this.objectType, this.detailed});
    ...
    MainPair1.fromJson(Map<String, dynamic> json) {
        ...
        objectId = json["object_id"];
        objectType = json["object_type"];
        detailed = json["detailed"] == null ? null : Detailed1.fromJson(json["detailed"]);
    }
...
class Detailed1 {
    ...
    Detailed1({this.objectId, this.objectType, this.type, this.imagePath, this.alt, this.imageX, this.imageY, this.httpImagePath, this.httpsImagePath, this.absolutePath, this.relativePath, this.isHighRes});
...
class ProductOptions2 {
    ...
    ProductOptions2({this.optionId, this.optionType, this.optionName, this.optionTypeName, this.selectedVariant, this.value});
...
class Shippings {
    ...
    Shippings({this.shippingId, this.shipping, this.description, this.serviceDeliveryTime, this.rate, this.formatRate});
...
class Bonuses1 {
    ...
    Bonuses1({this.bonus, this.discountBonus, this.discountValue, this.promotionId});
...
class Products {
    ...
    Products({this.userId, this.timestamp, this.type, this.userType, this.itemId, this.itemType, this.productId, this.amount, this.price, this.sessionId, this.ipAddress, this.orderId, this.storefrontId, this.position, this.companyId, this.productCode, this.product, this.productOptions, this.storedPrice, this.mainPair, this.extra, this.storedDiscount, this.amountTotal, this.optionsType, this.exceptionsType, this.optionsTypeRaw, this.exceptionsTypeRaw, this.modifiersPrice, this.isEdp, this.edpShipping, this.discount, this.promotions, this.basePrice, this.categoryIds, this.displayPrice, this.firstname, this.lastname, this.phone, this.email, this.userData, this.groupId, this.chosenShipping, this.subtotal, this.formatPrice, this.formatSubtotal, this.formatBasePrice, this.imageUrl, this.companyName, this.wishlistId});
    ...
    Products.fromJson(Map<String, dynamic> json) {
        ...
        productCode = json["product_code"];
        product = json["product"];
        productOptions = json["product_options"] == null ? null : (json["product_options"] as List).map((e) => ProductOptions.fromJson(e)).toList();
        storedPrice = json["stored_price"];
...
class UserData {
    ...
    UserData({this.userId, this.status, this.userType, this.userLogin, this.referer, this.isRoot, this.companyId, this.lastActivity, this.timestamp, this.salt, this.firstname, this.lastname, this.company, this.email, this.phone, this.fax, this.url, this.taxExempt, this.langCode, this.birthday, this.purchaseTimestampFrom, this.purchaseTimestampTo, this.responsibleEmail, this.passwordChangeTimestamp, this.apiKey, this.helpdeskUserId, this.janrainIdentifier, this.profileId, this.profileType, this.bFirstname, this.bLastname, this.bAddress, this.bAddress2, this.bCity, this.bCounty, this.bState, this.bCountry, this.bZipcode, this.bPhone, this.sFirstname, this.sLastname, this.sAddress, this.sAddress2, this.sCity, this.sCounty, this.sState, this.sCountry, this.sZipcode, this.sPhone, this.sAddressType, this.profileName, this.profileUpdateTimestamp, this.fields, this.bCountryDescr, this.sCountryDescr, this.bStateDescr, this.sStateDescr, this.points});
...
class MainPair {
    ...
    MainPair({this.pairId, this.imageId, this.detailedId, this.position, this.objectId, this.objectType, this.detailed});
...
class Detailed {
    ...
    Detailed({this.objectId, this.objectType, this.type, this.imagePath, this.alt, this.imageX, this.imageY, this.httpImagePath, this.httpsImagePath, this.absolutePath, this.relativePath, this.isHighRes});
...
class ProductOptions {
    ...
    ProductOptions({this.optionId, this.optionType, this.optionName, this.optionTypeName, this.selectedVariant, this.value});
...
class UserProfiles {
    ...
    UserProfiles({this.userId, this.status, this.userType, this.userLogin, this.referer, this.isRoot, this.companyId, this.lastActivity, this.timestamp, this.password, this.salt, this.firstname, this.lastname, this.company, this.email, this.phone, this.fax, this.url, this.taxExempt, this.langCode, this.birthday, this.purchaseTimestampFrom, this.purchaseTimestampTo, this.responsibleEmail, this.passwordChangeTimestamp, this.apiKey, this.helpdeskUserId, this.janrainIdentifier, this.profileId, this.profileType, this.bFirstname, this.bLastname, this.bAddress, this.bAddress2, this.bCity, this.bCounty, this.bState, this.bCountry, this.bZipcode, this.bPhone, this.sFirstname, this.sLastname, this.sAddress, this.sAddress2, this.sCity, this.sCounty, this.sState, this.sCountry, this.sZipcode, this.sPhone, this.sAddressType, this.profileName, this.profileUpdateTimestamp, this.fields, this.bCountryDescr, this.sCountryDescr, this.bStateDescr, this.sStateDescr, this.points});
