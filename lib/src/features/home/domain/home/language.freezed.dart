...
mixin _$Language {
 ...
 String get langId; String get langCode; String get name; String get countryCode; dynamic get direction;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Language&&(identical(other.langId, langId) || other.langId == langId)&&(identical(other.langCode, langCode) || other.langCode == langCode)&&(identical(other.name, name) || other.name == name)&&(identical(other.countryCode, countryCode) || other.countryCode == countryCode)&&const DeepCollectionEquality().equals(other.direction, direction));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,langId,langCode,name,countryCode,const DeepCollectionEquality().hash(direction));
...
@useResult
$Res call({
 String langId, String langCode, String name, String countryCode, dynamic direction
});
...
/// Create a copy of Language
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? langId = null,Object? langCode = null,Object? name = null,Object? countryCode = null,Object? direction = freezed,}) {
  return _then(_self.copyWith(
langId: null == langId ? _self.langId : langId // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String langId,  String langCode,  String name,  String countryCode,  dynamic direction)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Language() when $default != null:
return $default(_that.langId,_that.langCode,_that.name,_that.countryCode,_that.direction);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String langId,  String langCode,  String name,  String countryCode,  dynamic direction)  $default,) {final _that = this;
switch (_that) {
case _Language():
return $default(_that.langId,_that.langCode,_that.name,_that.countryCode,_that.direction);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String langId,  String langCode,  String name,  String countryCode,  dynamic direction)?  $default,) {final _that = this;
switch (_that) {
case _Language() when $default != null:
return $default(_that.langId,_that.langCode,_that.name,_that.countryCode,_that.direction);case _:
  return null;
...
class _Language implements Language {
   _Language({required this.langId, required this.langCode, required this.name, required this.countryCode, required this.direction});
  factory _Language.fromJson(Map<String, dynamic> json) => _$LanguageFromJson(json);

@override final  String langId;
@override final  String langCode;
@override final  String name;
@override final  String countryCode;
@override final  dynamic direction;
...
/// Create a copy of Language
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? langId = null,Object? langCode = null,Object? name = null,Object? countryCode = null,Object? direction = freezed,}) {
